...
class CPILESS
{
  ...
  {
    // Register less
    wp_register_script('less', get_template_directory_uri() . '/-/js/less-1.3.0.js', array(), false, true);
...
// Init
add_action('init', array('CPILESS', 'init'));
...
update_post_meta($post_id, "logolink", $_POST["logolink"]);
...
<p><label>Client Testimony Two:</label><br />
  ...
  <p><label>Client Logo:</label><br />
  <textarea cols="70" rows="1" name="logolink"><?php echo $logolink; ?></textarea></p>
...
// Gravity form change address to UK specific
