...
<nav>
    ...
    <img src="<?php bloginfo('template_url'); ?>/-/images/icon/pe-icon.png" alt="ib-icon" width="41" height="41" class="tech-icon" />
		<h2 class="serviceHeader">About <br/>Printable Electronics</h2>
			<ul> 
...
<section id="page-header"> 
  ...
  <p>Your browser does not support iframes.</p>
    ...
    <a href="http://www.uk-cpi.com/wp-content/uploads/2012/03/Printable-Electronics-Equipment-List.pdf" class="btn">View our Equipment List</a>
    <a href="http://www.uk-cpi.com/wp-content/uploads/2012/01/LACE.pdf" class="btn">View our OLED/OPV Prototyping Line</a>
	</div>
