<?php
/*
Template Name: markets-home

 * The template for displaying the Markets in the CPI INNOVATOR THEME
 */

get_header(); ?>
	
				<h1>Markets</h1>
	<p>The number of markets in which CPI operates is growing as facilities and capabilities are added to the company's portfolio. The most notable of these markets include, but are not limited to:</p></br>
...
=======
		<section class="box-container" id="markets">
...
>>>>>>> refs/heads/master
		...
		<a href="<?php bloginfo('url'); ?>/markets/built-environment/"><img src="<?php bloginfo( 'template_url' ); ?>/-/images/content/markets/built-environment.jpg" alt="Built Environment" width="285" height="90" />
		<h2 class="marketHeader">Built Environment</h2></a>
		</div>
		...
		<h2 class="marketHeader">Energy & Lighting</h2></a>
		</div>
		
		<div class="menu-box b-bottom">
		<a href="<?php bloginfo('url'); ?>/markets/food-and-drink-market/"><img src="<?php bloginfo( 'template_url' ); ?>/-/images/content/markets/ice-cream-small.jpg" alt="food and drink" width="285" height="90" />
		<h2 class="marketHeader">Food and Drink</h2></a>
		</div>
		...
		<div class="menu-box b-bottom b-right">
			<a href="<?php bloginfo('url'); ?>/markets/personal-care/"><img src="<?php bloginfo( 'template_url' ); ?>/-/images/content/markets/personal-care.jpg" alt="personal care" width="285" height="90" />
			<h2 class="marketHeader">Personal Care</h2></a>
		</div>
		
		
		<div class="menu-box b-bottom">
			<a href="<?php bloginfo('url'); ?>/markets/pharmaceuticals/"><img src="<?php bloginfo( 'template_url' ); ?>/-/images/content/markets/pharmaceuticals.jpg" alt="pharmaceuticals" width="285" height="90" />
			<h2 class="marketHeader">Pharmaceuticals</h2></a>
		</div>
