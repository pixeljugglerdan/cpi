...
>>>>>>> refs/heads/master
  	...
  	<?php } ?>
        ...
        <!-- If Download-->
<<<<<<< HEAD
    <?php if ( get_post_meta($post->ID, 'downloadlink', true) ) : ?></br></br></br>
    	<div class="casestudyspace"><a href="<?php echo get_post_meta($post->ID, 'downloadlink', true); ?>" class="btn">Download <?php the_title(); ?> Case Study</a></div>
=======
