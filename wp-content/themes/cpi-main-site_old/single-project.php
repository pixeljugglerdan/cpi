...
<<<<<<< HEAD
	<span class="section-title"><h2><a class="btn large" href="<?php bloginfo('url'); ?>/projects/">Projects</a> <?php echo $terms = get_the_term_list( $post->ID, 'technology-project'); ?></h2></span>
=======
...
<<<<<<< HEAD
	<a class="btn" href="<?php echo get_post_meta($post->ID, 'projectsite', true); ?>" target="_blank">View <?php the_title(); ?> Website</a>
=======
