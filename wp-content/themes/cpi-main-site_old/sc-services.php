...
<<<<<<< HEAD
		<h2 class="serviceHeader">Smart Chemistry<br/> Facilities</h2>
			<ul> 
    		<?php wp_nav_menu( array( 'sort_column' => 'menu_order', 'menu' => 'SC Facilities', 'items_wrap' => '%3$s' ) ); ?>
			</ul> 
    </nav>
...
=======
		<h2 class="serviceHeader">Smart Chemistry<br/> Services</h2>
			<ul> 
...
<section class="box-container" id="postPageHeader"> 
	...
	<div id="postPageHeader-Title" class="sc-section-header">
		<?php if ( have_posts() ) while ( have_posts() ) : the_post(); ?>
		<h1><?php the_title(); ?></h1>
	</div>
