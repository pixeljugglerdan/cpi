...
<<<<<<< HEAD
		<div id="markets" class="business-support-page">
		
		<div class="menu-box b-bottom b-right mark-top">
=======
		<section id="markets" class="box-container business-support-page">
...
<a href="<?php bloginfo('url'); ?>/business-support/incubator-space/"><img src="<?php bloginfo( 'template_url' ); ?>/-/images/content/business-support/incubator-space.png" alt="electronics" width="285" height="90" />
		<h2 class="serviceHeader">Incubator Space</h2></a>
...
>>>>>>> refs/heads/master
		<a href="<?php bloginfo('url'); ?>/business-support/market-technology-intelligence/"><img src="<?php bloginfo( 'template_url' ); ?>/-/images/content/business-support/market-intel.png" alt="electronics" width="285" height="90" />
				<h2 class="serviceHeader">Market & Technology Intelligence</h2></a>
				Market intelligence can turn a great idea into a viable business. CPI will help determine the strength of your market position and enable you to find exploitable market opportunities.
		...
		<h2 class="serviceHeader">Business & Technology Partnering</h2></a>
		...
		<h2 class="serviceHeader">Technology Commercialisation</h2></a>
...
>>>>>>> refs/heads/master
		...
		<h2 class="serviceHeader">Business Start Up Support</h2></a>
...
>>>>>>> refs/heads/master
		...
		<h2 class="serviceHeader">Funding</h2></a>
				CPI work closely with enterprises from all sectors to help indentify sources of business finance.
		</div>
