...
$.ajaxSetup({cache:false});
				$("#tenderMenu li a").click(function(){
					...
					$("#your_post_here").load("http://alpha.uk-cpi.com/ajax-tenders/",{id:post_id});
					return false;
					});
...
$.ajaxSetup({cache:false});
				$("#careersMenu li a").click(function(){
					...
					$("#your_post_here").html("loading...");
					$('div.tenderAlert').hide();
					$("#your_post_here").load("http://alpha.uk-cpi.com/ajax-careers/",{id:post_id});
					return false;
					});
...
$scroll
  .before('<img class="scrollButtons left" src="http://localhost:8888/cpi/wp-content/themes/CPI/-/images/scroll_left.png" />')
  .after('<img class="scrollButtons right" src="http://localhost:8888/cpi/wp-content/themes/CPI/-/images/scroll_right.png" />');
