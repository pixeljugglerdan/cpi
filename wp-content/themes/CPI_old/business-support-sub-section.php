<?php
/*
Template Name: business-support-sub-section

 * The template for displaying business-support pages in the CPI INNOVATOR THEME Printable Electronics Section
 */

get_header(); ?>

<div id="titleArea">	
	<span class="section-title"><h1><a href="<?php bloginfo('url'); ?>/business-support/">Business Support</a></h1></span>
    ...
    <nav>
			<ul> 
    		<?php wp_nav_menu( array( 'sort_column' => 'menu_order', 'menu' => 'Business Support', 'items_wrap' => '%3$s' ) ); ?>
			</ul> 
    </nav>
