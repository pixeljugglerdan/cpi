<?php include('header.php'); ?>
	...
	<ul id="nav">
		...
		<li><a href="#c">Our Resources</a></li>
		<li><a href="#d">Innovative Products</a></li>
		<li><a href="#f">Manufacturing Process</a></li>
		<li><a href="#g">New Business Models</a></li>
		<li><a href="#h">Closing Thoughts</a></li>
	</ul>
	
	<div id="progress-gray"></div>
	<div id="progress" data-0="width:0%;background:hsl(203, 100%, 37%);" data-end="width:100%;background:hsl(203, 100%, 49%);"></div>


<?php include('start.php'); ?>
<?php include('about.php'); ?>
<?php include('resources.php'); ?>
<?php include('efficient.php'); ?>
<?php include('innovation.php'); ?>
<?php include('manufacturing.php'); ?>
<?php include('newbusiness.php'); ?>
...
<script type="text/javascript">
  ...
  <script src="javascripts/jquery.fittext.js"></script>
	<script type="text/javascript">
		...
		$(".fittext2").fitText(0.5);
		$(".fittext3").fitText(1.1);
		$(".fittext4").fitText(0.75);
		$(".fittext5").fitText(0.90);
	</script>
